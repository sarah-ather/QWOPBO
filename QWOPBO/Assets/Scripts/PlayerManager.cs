...
public class PlayerManager
{
    ...
    private PlayerPunching m_Punching;                        // Reference to tank's movement script, used to disable and enable control.
    private EnemyMovement e_Movement;
    //private EnemyPunching m_Shooting;                        // Reference to tank's shooting script, used to disable and enable control.
    ...
    public void SetupAI(List<Transform> wayPointList)
    {
        ...
        //m_Shooting = m_Instance.GetComponent<EnemyPunching>();
        //m_Shooting.m_PlayerNumber = m_PlayerNumber;
        //e_Movement = m_Instance.GetComponent<EnemyMovement>();
        //Wm_Movement.m_PlayerNumber = m_PlayerNumber;
    ...
    public void SetupPlayer()
    {
        ...
        m_Punching = m_Instance.GetComponent<PlayerPunching>();
